...
def exercise(folder: Path, python: str, recover: bool) -> None:
    ...
    try:
        ...
        wait_gone(second)
        checks.append(
            "native start failure: new registration removed, previous running definition restored"
        )
